<template>
  <div class="max-w-4xl">
    <div class="mb-8">
      <h2 class="text-3xl font-bold   mb-2">Segurança</h2>
    ...
    <div class="rounded-lg shadow-sm border p-6">
      <h3 class="text-xl font-semibold mb-4 ">Autenticação de Dois Fatores</h3>
      <div class="flex items-center justify-between">
        <div>
          <p >Proteja sua conta com autenticação de dois fatores</p>
          <p class="text-sm">Recomendado para maior segurança</p>
        </div>
